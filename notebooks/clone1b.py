...
# %%
train_list, valid_list = ebdata.load_cached_clone_filelist(dset_dir)

# %%
train_ds = ebdata.CloneDataset(train_list, nbins=nbins, img_ds_factor=img_ds_factor)
train_loader = DataLoader(train_ds, batch_size=4, shuffle=True, pin_memory=True)
valid_ds = ebdata.CloneDataset(valid_list, nbins=nbins, img_ds_factor=img_ds_factor)
...
# %%
params = ebutils.try_load_model(model_dir, 'clone1')
if params is None:
