...
# %%
train_ds = ebdata.WpDataset(train_list, nbins=nbins, img_ds_factor=img_ds_factor, flip=True)
...
# %%
bi = 3
print(ebdata.undiscretize(by[bi].item(), train_ds.bins))
ebdata.unpreprocess(bx[bi])
